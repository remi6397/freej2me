...
import pl.nelz.mini.javaximpl.midi.Sequence;
import pl.nelz.mini.javaximpl.sound.Clip;
    ...
    public PlatformPlayer(InputStream stream, String type) {
        ...
        if (!Mobile.sound) {
            ...
            if (type.equals("audio/midi") || type.equals("sp-midi") || type.equals("audio/spmidi")) {
                ...
                if (type.equals("audio/x-wav") || type.equals("audio/amr")) {
